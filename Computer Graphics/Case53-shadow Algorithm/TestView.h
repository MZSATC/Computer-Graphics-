...
public:
	...
	void DrawCube(CDC *pDC,CZBuffer *zbuffer);//绘制立方体
	void DrawGround(CDC *pDC);//绘制地面
	void DrawShadow(CDC *pDC,CZBuffer *zbuffer);//绘制阴影
	CP3 CalculateCrossPoint(CP3 p0,CP3 p1);//计算光线与地面的交点
// Overrides
